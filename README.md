...
- examples  `lora_spi_send`, `lora_spi_receive` and `lora_spi_gps` use crate [rust-radio-sx127x](https://github.com/ryankurte/rust-radio-sx127x).
The crate is in transition to `embedded-hal 1.0.0 alpha` but has worked previously. To find the version that worked see the Cargo.lock files in 
the directory indicated by the `runs` link.

- examples`lora_send`, `lora_receive` and `lora_gps` use crate [sx127x_lora from hdoordt](https://github.com/hdoordt/sx127x_lora) or fork
[mr-git](https://github.com/mr-glt/sx127x_lora) or [mvniekerk](https://github.com/mvniekerk/sx127x_lora). These compile but I have not got them to run.
...
| {{stm32f1}} | {{b01}} |<img src="{{db01}}dht.png" {{p}} /> {{runH}} |<img src="{{db01}}dht11.png" {{p}} />   no-2  |<img src="{{db01}}text_i2c.png" {{p}} /> {{runA}} |<img src="{{db01}}oled_gps.png" {{p}} />   no-3   |<img src="{{db01}}lora_spi_send.png" {{p}} /> {{runG}} |<img src="{{db01}}lora_spi_receive.png" {{p}} /> {{runG}} |<img src="{{db01}}lora_spi_gps.png" {{p}} /> {{runG}} |<img src="{{db01}}lora_send.png" {{p}} />        |<img src="{{db01}}lora_receive.png" {{p}} />   |<img src="{{db01}}lora_gps.png" {{p}} />   |
| {{stm32f3}} | {{b02}} |<img src="{{db02}}dht.png" {{p}} /> {{runH}} |<img src="{{db02}}dht11.png" {{p}} />         |<img src="{{db02}}text_i2c.png" {{p}} /> {{runB}} |<img src="{{db02}}oled_gps.png" {{p}} />{{runB}}-4|<img src="{{db02}}lora_spi_send.png" {{p}} />          |<img src="{{db02}}lora_spi_receive.png" {{p}} />          |<img src="{{db02}}lora_spi_gps.png" {{p}} />          |<img src="{{db02}}lora_send.png" {{p}} />        |<img src="{{db02}}lora_receive.png" {{p}} />   |<img src="{{db02}}lora_gps.png" {{p}} />   |
