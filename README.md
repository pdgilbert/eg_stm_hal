...
| {{stm32f1}} | {{b01}} |<img src="{{db01}}dht.png" {{p}} />   no-2  |<img src="{{db01}}dht11.png" {{p}} />   no-2  |<img src="{{db01}}text_i2c.png" {{p}} /> {{runA}} |<img src="{{db01}}oled_gps.png" {{p}} />   no-3   |<img src="{{db01}}lora_spi_send.png" {{p}} />   |<img src="{{db01}}lora_spi_receive.png" {{p}} />   |<img src="{{db01}}lora_spi_gps.png" {{p}} />   |<img src="{{db01}}lora_send.png" {{p}} />	|<img src="{{db01}}lora_receive.png" {{p}} />	|<img src="{{db01}}lora_gps.png" {{p}} />   |
...
| {{stm32f4}} | {{b04}} |<img src="{{db04}}dht.png" {{p}} />   no-1  |<img src="{{db04}}dht11.png" {{p}} />   no-1  |<img src="{{db04}}text_i2c.png" {{p}} /> {{runB}} |<img src="{{db04}}oled_gps.png" {{p}} /> {{runB}} |<img src="{{db04}}lora_spi_send.png" {{p}} />   |<img src="{{db04}}lora_spi_receive.png" {{p}} />   |<img src="{{db04}}lora_spi_gps.png" {{p}} />   |<img src="{{db04}}lora_send.png" {{p}} />	|<img src="{{db04}}lora_receive.png" {{p}} />	|<img src="{{db04}}lora_gps.png" {{p}} />   |
