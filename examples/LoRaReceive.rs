...
use stm32f1xx_hal::{prelude::*,   
                    ...
                    spi::{Spi, Spi1NoRemap},
                    delay::Delay,
		    //gpio::{gpiob::{PB5, PB6, PB7}, Alternate, OpenDrain,  gpioc::PC13, Output, PushPull,},
...
use stm32f3xx_hal::{prelude::*, 
                    ...
                    spi::{Spi},
                    delay::Delay,
		    //gpio::{gpiob::{PB5, PB6, PB7}, AF5,   gpiob::PE9, Output, PushPull,  },
		    gpio::{gpioa::{PA5, PA6, PA7}, AF5,  gpiob::{PB13, PB14}, Output, PushPull},
		    stm32::SPI1,
		    };
...
use stm32f4xx_hal::{prelude::*,  
                    ...
                    spi::{Spi},
                    delay::Delay,
		    gpio::{gpioa::{PA5, PA6, PA7}, Alternate, AF5,  gpiob::{PB13, PB14}, Output, PushPull},
                    time::MegaHertz,
		    pac::SPI1,
		    }; 
