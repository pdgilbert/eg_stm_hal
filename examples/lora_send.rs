...
use stm32h7xx_hal::{
    delay::Delay,
    gpio::{
        //gpioa::{PA5, PA6, PA7}, Alternate, AF5,  really!
        gpioa::{PA0, PA1},
        Output,
        PushPull,
    },
...
use stm32l1xx_hal::{
    delay::Delay,
    gpio::{
        //gpioa::{PA5, PA6, PA7}, Input,  Floating,
        gpioa::{PA3, PA4},
        Output,
        PushPull,
    },
...
fn setup() -> (
    sx127x_lora::LoRa<Spi<SPI1, impl Pins<SPI1>>, PA4<Output<PushPull>>, PA3<Output<PushPull>>>,
    Delay,
) {
